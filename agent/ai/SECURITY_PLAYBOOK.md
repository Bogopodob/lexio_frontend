...
> Дополнение к `SECURITY_PLAYBOOK.md` (backend Laravel). Этот документ — фронтенд-часть для медицинского проекта: React, Vite, TypeScript, архитектура Feature-Sliced Design (FSD).
