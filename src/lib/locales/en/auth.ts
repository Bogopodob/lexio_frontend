...
const en: typeof ruAuth = {
  ...
  card: {
    ...
    codeTitleLogin: 'Code sent',
    codeTitleRegister: 'Account created — code sent',
    fieldName: 'Name',
    fieldEmail: 'Email',
    ...
    codeSentTo: 'We sent it to {email}',
    codeInputLabel: 'Code from email',
    codeExpires: 'Valid for {minutes} min. No email? Check spam.',
    resendCode: 'Send again',
    resendIn: 'Again in {seconds}s',
    changeEmail: 'Change email',
    debugHint: 'Dev code: {code}',
