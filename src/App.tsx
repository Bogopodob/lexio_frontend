...
const topicCards = [
  ...
  },
  {
    ...
    title: 'Эмоции',
    count: '36 слов',
    tone: 'topic-card--rose',
  },
  {
    emoji: '💼',
    title: 'Работа',
    count: '44 слова',
    tone: 'topic-card--sand',
  },
]

const grammarCards = [
  {
    dot: 'grammar-card__dot--mint',
    title: 'Глаголы',
    subtitle: '200 слов • 34 выучено',
    progress: 17,
    level: 'Основа речи',
  },
  {
    dot: 'grammar-card__dot--blue',
    title: 'Существительные',
    subtitle: '300 слов • 12 выучено',
    progress: 4,
    level: 'База словаря',
  },
  {
    dot: 'grammar-card__dot--pink',
    title: 'Прилагательные',
    subtitle: '150 слов • 8 выучено',
    progress: 5,
    level: 'Описание',
  },
  {
    dot: 'grammar-card__dot--gold',
    title: 'Фразы',
    subtitle: '80 фраз • 0 выучено',
    progress: 0,
    level: 'Практика',
  },
]
...
const phraseCards = [
  {
    label: 'РЕСТОРАН',
    accent: 'phrase-card__label--mint',
    icon: '◌',
    title: 'Can I have the bill, please?',
    translation: 'Можно счёт, пожалуйста?',
  },
  {
    label: 'ГОРОД',
    accent: 'phrase-card__label--blue',
    icon: '⌁',
    title: 'Where is the nearest metro?',
    translation: 'Где ближайшее метро?',
  },
  {
    label: 'ОТЕЛЬ',
    accent: 'phrase-card__label--pink',
    icon: '✦',
